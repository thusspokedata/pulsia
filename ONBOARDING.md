...
- **`estimateFoodMicros`** (`backend/src/ai/client.ts`) estima los 30 nutrientes del registro con
  conocimiento + la herramienta server-side **`web_search`** de Anthropic. Como forzar `tool_choice`
