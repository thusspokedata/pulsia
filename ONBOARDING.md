...
> Documento de contexto para retomar el proyecto en una sesión nueva. Última actualización: **2026-08-17**.
>
> El **historial detallado de sesiones** (los bloques `§0-*` fechados, "✅ HECHO …", del 2026-07-09 al 2026-08-17) se archivó en **[`docs/ONBOARDING-HISTORY.md`](docs/ONBOARDING-HISTORY.md)** para mantener este handoff enfocado en lo durable. Acá quedan el **estado actual** (§0, abajo) y la **referencia estable** (§1–§11). Para el "porqué" y el detalle de cada feature entregada: el historial, el `git log`, o la memoria persistente (§11).
