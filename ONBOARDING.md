...
propio `overflow-x-auto`), y un contador **X/365** (días entrenados / días del año) que también se
agregó al móvil, arriba del heatmap, sin tocar el título (que un test fija).
