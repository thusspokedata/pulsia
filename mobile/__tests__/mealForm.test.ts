...
const banana = { id: "f1", name: "Banana", basis: "per_100g" as const, kcal: 89, protein_g: 1.1, carbs_g: 23, fat_g: 0.3, unitWeightG: 120, source: "estimate" as const, createdAt: 0, saturated_fat_g: 0.1, sugars_g: 12, fiber_g: 2.6, salt_g: 0 };
const leche = { id: "f2", name: "Leche", basis: "per_100ml" as const, kcal: 42, protein_g: 3.4, carbs_g: 5, fat_g: 1, unitWeightG: null, source: "label" as const, createdAt: 0, saturated_fat_g: 0.6, sugars_g: 5, fiber_g: null, salt_g: 0.1 };
