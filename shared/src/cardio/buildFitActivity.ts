import type { CardioActivity, CardioFitPreview, CardioType } from "../schemas/cardio";
...
//
// Vive en @pulsia/shared (no en mobile) porque los DOS clientes lo necesitan: el móvil (confirmación
// manual con form) y la web (subida batch, que rellena el form con los propios valores del preview).
// Es pura y solo depende de tipos, así que se comparte sin arrastrar deps de RN.
